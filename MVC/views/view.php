...
<body>		 <!--creating input field for ionsertion -->	
		
        <!-- Modal content -->
        
  <button id="myBtn">CREATEPROFILE</button>
			...
			<div>
				...
				<form name="insertForm" method="post" action="" id="insertForm">
					<table border=0px" align="center" cellspacing="5px" class="table">
						...
						<tr><td><input type="submit" name="submitbtn" id="submitbtn" value="Submit">
						<td><input type="button" name="resetbttn" id="resetbttn" value="Reset"></td></tr>
					</table>
      ...
      <div class="modal-content1">
        ...
        <form action=" " method="post" name="updateForm" id="updateForm">
         <table border=0px" align="center" cellspacing="5px" class="table">
						...
						<tr><td><input type="submit" name="edit_submitbtn" id="edit_submitbtn" value="Submit">
						<td><input type="button" name="resetbttn" id="edit_resetbttn" value="Reset"></td></tr>
					</table>
        </div>
    </div>
    </div>
		...
		<form>
				...
				<?php 
					...
					for ($i=0; $i <count($result); $i++) { 
						...
						echo '<td>'.$result[$i]['textEmail'].'</td>';
						echo '<td>'.$result[$i]['mobno'].'</td>';
						echo '<td>'.$result[$i]['city'].'</td>';
						echo '<td>'.$result[$i]['ste'].'</td>';
						echo '<td><img title="Edit" src="images/Edit_icon.png" id="edit" editid="'.$result[$i]['id'].'">&nbsp;&nbsp;&nbsp;<img title="Delete" src="images/delete.png" id="del" deleteid="'.$result[$i]['id'].'"></td>';
						echo '</tr>';
						$sno++;			
					}
					*/
...
function displayRecords(){
	...
	$.ajax({
     ...
     $('#myBtn').click(function(){
     	//$('#myModal').model('clearInputFields()');
     ...
     else if(event.target == modal1)
      {
        modal1.style.display = "none";
    		...
    		/* $("#submitbtn").on("click",function()
    		 ...
    		 //getting input from update field of html to php 
